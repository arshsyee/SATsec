      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="bg-white/[0.025] border border-white/[0.07] rounded-2xl p-8">
          ...
          <div className="mt-4 text-center">
            <Link to="/forgot-password" className="text-xs text-[#4a6070] hover:text-accent-bright font-mono transition-colors">
              Forgot password?
            </Link>
          </div>
        </div>
        ...
        <p className="text-center text-xs text-[#3a5068] font-mono mt-5">
          No account?{' '}
          <Link to="/register" className="text-accent-bright hover:text-accent-bright transition-colors">
            Sign up free
          </Link>
        </p>
      </div>
